...
namespace TeamJ.SKS.Package.Services.Test
{
    class StaffApiTest
    {
        ...
        public void ReportParcelDelivery_ValidTrackingID_Success()
        {
            ...
            mockWebhookManager.Setup(pl => pl.ListParcelWebHooks("123456789")).Returns(new List<BLWebhookResponse>());
            Mock<ILogger<StaffApiController>> mockLogger = new Mock<ILogger<StaffApiController>>();
            var controller = new StaffApiController(mockParcelLogic.Object, mockLogger.Object, mockWebhookManager.Object);
